...
| `validation.js` | Island stats (including **Population supply**: need from placed houses vs nameplate output from placed producers), validation (warehouse/service coverage, tile resources, overlap) |
